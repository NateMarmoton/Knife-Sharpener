...
{
	// Resolution
	const uint8_t        caset[4]       = {0x00, 0x00, (ST7789_LCD_WIDTH - 1) >> 8, (ST7789_LCD_WIDTH - 1) & 0xff};
	...
	const st7789_Command initSequence[] = {
	    ...
	    {ST7789_CMD_RASET, 0, 4, (const uint8_t*)&raset},   // Set height5
	    // Porch setting
